...
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{rosmake.txt}
...
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{rostopic.txt}

\textbf{Output:}
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{rostopic_output.txt}
...
\newline
\textbf{Command:} 
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{rostopic_echo.txt}
\textbf{Output:}
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{rostopic_echo_2.txt}
\end{frame}
%----------------------------------------------------------------------------------------
...
\textbf{Command:} 
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{rosservice_list.txt}

\textbf{Output:}
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{rosservice_list_2.txt}
\end{frame}
%----------------------------------------------------------------------------------------
\begin{frame}{rosservice - Example}
...
\newline
\textbf{Command:} 
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{rosservice_clear.txt}
\textbf{Output:}
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{rosservice_clear_1.txt}
...
\textbf{Command:} 
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{rosservice_clear_2.txt}
There are no further arguments because the service is of type empty.
\newline
Otherwise the usage is:
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{rosservice_clear_3.txt}
This does what expected, it clears the background of the turtlesim\_node.
\begin{figure}[h]\centering
	\subfigure[Figure 1]{\includegraphics[width = 0.26\textwidth]{turtle_line.png}}
	\subfigure[Figure 2]{\includegraphics[width = 0.285\textwidth]{turtle_clear.png}}
\end{figure}
\end{frame}
%----------------------------------------------------------------------------------------
...
\newline
\textbf{Command:} 
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{rosmsg_type.txt}

\textbf{Output:}
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{rosmsg_type_1.txt}
\end{frame}
%----------------------------------------------------------------------------------------
...
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{launch.txt}
...
\end{large}
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{launch_2.txt}
\end{frame}
%----------------------------------------------------------------------------------------
\begin{frame}{Launch Files - Example 2}
	...
	\end{large}
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{launch_3.txt}
\end{frame}
%----------------------------------------------------------------------------------------
\begin{frame}{Launch Files}
	The stucture of the path is usually: \\
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{launch_4.txt}
...
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{launch_5.txt}
...
\lstinputlisting[frame=single, basicstyle=\footnotesize\ttfamily, language=C]{launch_1.txt}
\end{frame}
%----------------------------------------------------------------------------------------
\begin{frame}
